import { Eye, CheckCircle2, RotateCcw, MessageSquare } from 'lucide-react';
...
export default function MentorSubmissions({ submissions, tasks, profiles, students }: Props) {
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">Review student submissions</p>
      </div>
      ...
      <DataTable
        ...
        actions={() => (
          <div className="flex items-center gap-2">
            ...
            <button className="p-1.5 text-gray-400 hover:text-blue-400 transition-colors" title="Comment">
